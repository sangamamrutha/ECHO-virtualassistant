...
btn.addEventListener('click', () => {
    content.textContent = 'Listening...'; // Update content to show listening state
    content.classList.add('fadeInOut'); // Apply fade in/out animation class
    recognition.start();
});
...
recognition.onresult = (event) => {
    ...
    content.classList.remove('fadeInOut'); // Remove animation class after setting text
    setTimeout(() => {
        content.classList.add('fadeInOut'); // Reapply animation class for text speaking
